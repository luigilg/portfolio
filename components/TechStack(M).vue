<template>
    <div ref="gridRef" class="grid grid-cols-3 gap-[6vw] p-[6vw]">
        <TechCard(M)
            class="tech-card-item opacity-0 translate-y-10"
...
const techList = ref([
    ...
    { logo: 'typescript', color: '#2f74c0' },
    { logo: 'vue', color: '#4ebf8c' },
    { logo: 'react', color: '#61dbfb' },
    { logo: 'angular', color: '#e42939' },
